		...
		public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key)
		{
			...
			if ("viper4android.headphonefx.convolver.kernel".equals(key))
			{
				...
				if (szSrcIRFile != "")
				{
					...
					String szToolbox = Utils.GetSavedToolbox(ViPER4Android.SHARED_PREFERENCES_BASENAME + ".settings", mActivityContext);
			    	if (!szToolbox.equals(""))
			    	{
			        	String szCopy   = Utils.MakeCopyCmdLine(ViPER4Android.SHARED_PREFERENCES_BASENAME + ".settings", mActivityContext, szSrcIRFile, szDstFile);
